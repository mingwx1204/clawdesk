...
#![allow(dead_code, unused_variables)] // 移植库模块·供后续集成
//!
...
use chrono::Utc;
use crate::harness::paths::{CODEWHALE_APP_DIR, LEGACY_APP_DIR, codewhale_home_override};
...
pub use crate::harness::protocol::ThreadStatus;
...
pub fn default_state_db_path() -> PathBuf {
    ...
    let home = crate::harness::paths::user_home().unwrap_or_else(|| PathBuf::from("."));
